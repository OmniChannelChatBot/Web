...
export interface IOAuthApiServiceClient {
     ...
     */
    authentification(body: AuthentificationCommand): Promise<AuthentificationCommandResponse>;
    /**
     * @return Sign in
     */
    signIn(body: SignInCommand): Promise<void>;
    /**
     * @return Sign up
     */
    signUp(body: SignUpCommand): Promise<void>;
    /**
     * @return Refreshed
     */
    refreshByCookie(): Promise<void>;
    /**
     * @return Refreshed
     */
    refresh(body: RefreshCommand): Promise<RefreshCommandResponse>;
    /**
     * @return Success
     */
    getUser(): Promise<GetUserQueryResponse>;
}
...
export class OAuthApiServiceClient implements IOAuthApiServiceClient {
    ...
    authentification(body: AuthentificationCommand): Promise<AuthentificationCommandResponse> {
        ...
        return this.instance.request(options_).then((_response: AxiosResponse) => {
            return this.processAuthentification(_response);
        });
    }

    protected processAuthentification(response: AxiosResponse): Promise<AuthentificationCommandResponse> {
        ...
        if (status === 200) {
            ...
            result200 = AuthentificationCommandResponse.fromJS(resultData200);
            return result200;
        } else if (status === 504) {
            const _responseText = response.data;
        ...
        return Promise.resolve<AuthentificationCommandResponse>(<any>null);
    }
     ...
     */
    refreshByCookie(): Promise<void> {
        let url_ = this.baseUrl + "/api/auth/refresh/cookie";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.instance.request(options_).then((_response: AxiosResponse) => {
            return this.processRefreshByCookie(_response);
        });
    }

    protected processRefreshByCookie(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    protected processRefresh(response: AxiosResponse): Promise<RefreshCommandResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = RefreshCommandResponse.fromJS(resultData200);
            return result200;
        } else if (status === 504) {
            const _responseText = response.data;
            let result504: any = null;
        ...
        return Promise.resolve<RefreshCommandResponse>(<any>null);
    }
    ...
    protected processGetUser(response: AxiosResponse): Promise<GetUserQueryResponse> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = GetUserQueryResponse.fromJS(resultData200);
            return result200;
        } else if (status === 404) {
            const _responseText = response.data;
        ...
        return Promise.resolve<GetUserQueryResponse>(<any>null);
    }
}

export class AuthentificationCommand implements IAuthentificationCommand {
    username!: string;
    password!: string;

    constructor(data?: IAuthentificationCommand) {
        if (data) {
    ...
    static fromJS(data: any): AuthentificationCommand {
        data = typeof data === 'object' ? data : {};
        let result = new AuthentificationCommand();
        result.init(data);
        return result;
    }
...
export interface IAuthentificationCommand {
    username: string;
    password: string;
}

export class AuthentificationCommandResponse implements IAuthentificationCommandResponse {
    accessToken!: string;
    refreshToken!: string;

    constructor(data?: IAuthentificationCommandResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AuthentificationCommandResponse {
        data = typeof data === 'object' ? data : {};
        let result = new AuthentificationCommandResponse();
        result.init(data);
        return result;
    }
...
export interface IAuthentificationCommandResponse {
    accessToken: string;
    refreshToken: string;
}
...
export class RefreshCommand implements IRefreshCommand {
    accessToken!: string;
    refreshToken!: string;

    constructor(data?: IRefreshCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RefreshCommand {
        data = typeof data === 'object' ? data : {};
        let result = new RefreshCommand();
        result.init(data);
        return result;
    }
...
export class RefreshCommandResponse implements IRefreshCommandResponse {
    accessToken!: string;
    refreshToken!: string;

    constructor(data?: IRefreshCommandResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RefreshCommandResponse {
        data = typeof data === 'object' ? data : {};
        let result = new RefreshCommandResponse();
        result.init(data);
        return result;
    }
...
export interface IRefreshCommandResponse {
    accessToken: string;
    refreshToken: string;
}

export class GetUserQueryResponse implements IGetUserQueryResponse {
    userId!: number;
    username!: string;
    firstName!: string;
    lastName!: string;
    ...
    constructor(data?: IGetUserQueryResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetUserQueryResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetUserQueryResponse();
        result.init(data);
        return result;
    }
